  ...
  <div >
      ...
      <div class="fform">
        ...
        <div style="margin-top:450px;margin-left:50px">
            <div class="totalprice" >总收入：{{TotalPrice}}</div>
        </div>
      </div>
  </div>
</template>
  ...
  data() {
    ...
    methods: {
      ...
      onSubmit(radio) {
        var _this=this
        if(radio==1){
            this.$http.post(this.HOST+'/findincomebyday',{Date:this.value1},{
                headers: {
            ...
            this.$http.post(this.HOST+'/findincometotal',{Date:this.value1},{
                headers: {
                    'Content-Type': 'application/json;charset=UTF-8'
                }
            })          
            ...
            this.$http.post(this.HOST+'/findincomebymon',{Date:this.value2},{
                headers: {
                    'Content-Type': 'application/json;charset=UTF-8'
                }
            })          
            ...
            this.$http.post(this.HOST+'/findincometotalmon',{Date:this.value2},{
                headers: {
                    'Content-Type': 'application/json;charset=UTF-8'
                }
            })          
